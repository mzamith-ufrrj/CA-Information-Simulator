...
print("SEIR MODEL - Análise do Epsilon no tempo - curva do exposto")
limits_x <- 30
...
g <- ggplot() +
  geom_point(data = df_10, aes(x = time, y = exposed_percent,  color="df_10"), size=2.5)+
  geom_line(data = df_10, aes(x = time, y = exposed_percent,  color="df_10"))+
  
  geom_point(data = df_25, aes(x = time, y = exposed_percent,  color="df_25"), size=2.5) +
  geom_line(data = df_25, aes(x = time, y = exposed_percent,  color="df_25"))+
  
  geom_point(data = df_50, aes(x = time, y = exposed_percent,  color="df_50"), size=2.5) +
  geom_line(data = df_50, aes(x = time, y = exposed_percent,  color="df_50"))+

  geom_point(data = df_75, aes(x = time, y = exposed_percent,  color="df_75"), size=2.5) +
  geom_line(data = df_75, aes(x = time, y = exposed_percent,  color="df_75"))+

  geom_point(data = df_90, aes(x = time, y = exposed_percent,  color="df_90"), size=2.5) +
  geom_line(data = df_90, aes(x = time, y = exposed_percent,  color="df_90"))+
...
file_name_pdf <- "curva-epsilon-exposto.pdf"
