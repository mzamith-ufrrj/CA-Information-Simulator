...
function main_on_load_script(){
    ...
    document.getElementById("id_timesteps").value = 20;
    document.getElementById("id_lambda").value = 0.1;

    document.getElementById("id_alphaMi").value = 2.25;
    document.getElementById("id_alphaSig").value = 0.25;
    document.getElementById("id_gammaMi").value = 2.25;
    document.getElementById("id_gammaSig").value = 0.25;
...
function downloadJSON() {
    ...
    const global_param = JSON.stringify({
				...
				"lambda": document.getElementById("id_lambda").value,
...
async function main_run_simulation(){
    ...
    //------------------------------------------------------
        ...
        const dataEnconded = {
            ...
            lambda:  parseFloat(document.getElementById("id_lambda").value),     
        ...
        // Send to server
		    ...
		    console.log("ERROR debug:", data.debug_json);
                }
