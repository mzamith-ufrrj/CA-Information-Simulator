...
g <- ggplot() +
  ...
  labs(title = TeX("$\\epsilon$ = 0.1 / N($\\mu_{\\alpha}$ = 50, $\\sigma_{\\alpha}$ = 10) / N($\\mu_{\\gamma}$ = 50, $\\sigma_{\\gamma}$ = 0.5)"), color = "States:", x = "Time", y = "Nodes (Agents)") +
  theme_bw() + 
...
ggsave(filename = "SEIR-BN_1000_epsilon_1E-1_alpha_5E1_1E1_gamma_5E1_5E-1.pdf", width = 10, height = 6)
#print("File saved")
#   print(g)
